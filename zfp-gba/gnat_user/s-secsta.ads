...
package System.Secondary_Stack is
   ...
   subtype SS_Stack is SAL.Owning_Linear_Pool;
   ...
   subtype Mark_Id is SSP.Marker;
   --  Type used to mark the stack for mark/release processing.

   function SS_Mark return SSP.Marker with Inline;
   --  Return the Mark corresponding to the current state of the stack

   procedure SS_Release (M : SSP.Marker) with Inline;
